...
class grid(object):
    ...
    def _ensure_grid_file(self, clobber, **kwargs):
        ...
        if self.grid_name in ["POP_gx1v6", "POP_gx1v7", "POP_gx3v7", "POP_tx0.1v3"]:
...
def weight_file(src_grid, dst_grid, method="bilinear", extrap_method="none"):
    return f"{regrid_dir}/{src_grid.grid_name}_to_{dst_grid.grid_name}_{method}_extrap-{extrap_method}.nc"
...
class regridder(object):
    ...
    def __init__(
        self, src_grid, dst_grid, method="bilinear", extrap_method="none", clobber=False
    ):
        ...
        self.weight_file = weight_file(src_grid, dst_grid, method, extrap_method)
